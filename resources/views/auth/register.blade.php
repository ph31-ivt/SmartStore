                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="age" value="{{ old('age') }}" required autocomplete="age" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="img_url" type="file" class="form-control @error('name') is-invalid @enderror" name="img_url" value="{{ old('img_url') }}" required autocomplete="img_url" autofocus>
